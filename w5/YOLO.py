# Dataset utilities and dataloaders
...
from yolov5.utils.general import xyxy2xywh, xywh2xyxy, clean_str
...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    # Use torch.utilities.data.DataLoader() if dataset.properties will update during training else InfiniteDataLoader()
...
def extract_boxes(path='../coco128/'):  # from utilities.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0)):  # from utilities.datasets import *; autosplit('../coco128')
